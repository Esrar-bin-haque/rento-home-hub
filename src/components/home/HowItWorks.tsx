...
const HowItWorks = () => {
  ...
  const steps = [
    { icon: UserPlus, titleKey: "how_step1_title", descKey: "how_step1_desc" },
    { icon: Home, titleKey: "how_step2_title", descKey: "how_step2_desc" },
    { icon: Monitor, titleKey: "how_step3_title", descKey: "how_step3_desc" },
  ];
        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-8 md:gap-4 max-w-4xl mx-auto">
          {steps.map((s, i) => (
            <div key={i} className="flex-1 flex flex-col items-center text-center relative">
              ...
              <span className="text-xs font-medium mb-2" style={{ color: '#3B5BDB' }}>{t("how_step")} {i + 1}</span>
